...
window.I18N = {
  de: {
    ...
    uploadHint: "📤 Deine Fotos werden erst am Ende hochgeladen – klick dich durch bis zum Schluss und sende sie dort ab.",
  ...
  en: {
    ...
    uploadHint: "📤 Your photos are uploaded only at the end – click through to the finish and send them there.",
